 ...
 * @author marcu
 */
public class ExcluirMecanico extends javax.swing.JFrame {
    ...
    public ExcluirMecanico(MenuAdm menu_adm) {
        this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insira o ID do Mecânico que deseja excluir:");
    ...
    private void ConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmarActionPerformed
        mecanicoX = menu_adm.login.adm.getMecanico(Integer.parseInt(InputId.getText()));
        //Deletar o mecânico em questão através do Id passado no input
        if(adm.existFunc(2, Integer.parseInt(InputId.getText()))== 1){
            adm.removeMecanico(mecanicoX);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirMecanico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExcluirMecanico().setVisible(true);
            }
        });
    }
