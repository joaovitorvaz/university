...
public class CadastroMecanico extends javax.swing.JFrame {
    ...
    public CadastroMecanico(MenuAdm menu_adm) {
        this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRO MECÂNICO");
    ...
    private void CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadastrarActionPerformed
        //Criando um novo Mecânico e o inserindo na lista
        if(!(InputNome.getText()).equals("") && !(InputCpf.getText()).equals("") && !(InputRg.getText()).equals("") && !(InputEndereco.getText()).equals("") && !(InputTelefone.getText()).equals("") && !(InputSenha.getText()).equals("") && !(InputEmail.getText()).equals("")){
            adm.addMecanico(new Mecanico(InputNome.getText(), InputCpf.getText(), InputRg.getText(), InputEndereco.getText(), InputTelefone.getText(), InputEmail.getText(), InputUser.getText(), InputSenha.getText()));
            menu_adm.setAdminstrador(adm);
